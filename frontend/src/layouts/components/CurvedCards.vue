<script setup>
import beautyImage from '@/assets/icons/4.png'
import designImage from '@/assets/icons/6.png'
import techImage from '@/assets/icons/5.png'
...
const cards = [
  ...
  },
  {
    ...
    title: 'Writing',
    subtitle: 'Crafting compelling content',
    image: writingImage,
    x: 298,
    y: 40, // aligned top
  },
