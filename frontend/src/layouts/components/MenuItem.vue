...
const items = [
  ...
  { label: 'Service Providers', to: '/dashboard/providers' },
  { label: 'Messages', to: '/dashboard/messages' },
]

const userMenuItems = [
  { label: 'Profile', icon: 'pi pi-user', command: () => router.push('/dashboard/profile') },
  { label: 'Settings', icon: 'pi pi-cog', command: () => router.push('/dashboard/settings') },
  { separator: true },
