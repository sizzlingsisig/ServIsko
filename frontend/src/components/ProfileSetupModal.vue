    ...
    <div class="py-6">
          ...
          <div class="flex items-start gap-3">
            ...
            <div>
              ...
              <p class="text-sm text-blue-800">
                ...
                {{
                  isProvider
                    ? 'clients understand your background and increases your chances of getting hired'
      ...
      <div v-else-if="isProvider && currentStep === 1" class="space-y-6">
          ...
          <div class="flex items-start gap-3">
            ...
            <div>
              ...
              <p class="text-sm text-green-800">
                Add skills that represent your expertise. This helps clients find you for relevant
                projects.
              </p>
            </div>
          </div>
        ...
        <div>
          ...
          />
          <small v-if="form.errors.skills" class="text-red-500 block mt-1">{{
            form.errors.skills
          }}</small>
        </div>
        ...
        <div v-if="form.selectedSkills.length > 0" class="space-y-2">
          <label class="block font-semibold text-gray-700"
            >Selected Skills ({{ form.selectedSkills.length }})</label
          >
          <div class="flex flex-wrap gap-2">
            ...
            >
              ...
              <button @click="removeSkill(idx)" class="text-primary-600 hover:text-primary-800">
        ...
        <div class="space-y-4">
          ...
          <div v-if="isProvider && form.selectedSkills.length > 0">
            <h4 class="font-semibold text-gray-700 mb-2">
              Skills ({{ form.selectedSkills.length }})
            </h4>
            <div class="flex flex-wrap gap-2">
              <span
    ...
    <template #footer>
      <div class="flex justify-between items-center w-full">
        ...
        <div class="flex gap-2">
          <Button label="Skip for Now" text severity="secondary" @click="handleSkip" />
          <Button
