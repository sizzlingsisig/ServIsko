 ...
 *
 * @checksum - 34f328b49add92c38c7015750eda23303df606ee1938bc52803d84dcc76e2cae
 * @variables - radius=rounded-lg,accentColor=teal,colorTemperature=zinc,spacing=2,scale=sm,inputShadow=shadow-md,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
 * @theme - regenesis
 **/
...
const classes = {
  ...
  'family:box__decorator': {
    ...
    'bg-white': true,
    'ring-teal-500': true,
    'peer-checked:border-teal-600': false,
    relative: true,
    block: true,
    'text-base': true,
    'w-[1em]': true,
    ...
    'peer-checked:text-teal-600': false,
  ...
  'family:text__inner': {
    ...
    'focus-within:!ring-teal-500': false,
    'focus-within:!border-teal-500': false,
  ...
  'family:dropdown__emptyMessage': {
    ...
    'aria-selected:bg-teal-600': false,
  },
  button__input: {
    'appearance-none': true,
    '[color-scheme:light]': true,
  ...
  file__fileRemove: {
    ...
    'peer-data-[has-multiple]:text-teal-600': false,
  ...
  form__messageLink: {
    ...
    'group-[]/summary:ring-teal-600': false,
  },
  month__input: {
    'appearance-none': true,
    '[color-scheme:light]': true,
  ...
  range__input: {
    ...
    '[&::-webkit-slider-thumb]:bg-teal-600': false,
    ...
    '[&::-moz-range-thumb]:bg-teal-600': false,
  ...
  colorpicker__fieldGroup: {
    ...
    '[&>input:focus]:ring-teal-600': false,
    '[&>input:focus]:border-teal-600': false,
  ...
  datepicker__dayCell: {
    ...
    'dark:bg-zinc-600': true,
    'dark:text-zinc-300': true,
    'dark:aria-selected:bg-teal-600': false,
    'dark:aria-selected:text-white': true,
    'dark:focus:outline-teal-600': false,
  ...
  datepicker__timeInput: {
    ...
    'p-1.5': true,
    'my-2.5': true,
    'focus-visible:outline-teal-600': false,
    'dark:text-zinc-300': true,
    'dark:bg-transparent': true,
    'dark:border-zinc-600': true,
  },
  ...
  datepicker__calendarIcon: {
    'text-zinc-600': true,
    'focus-visible:text-teal-600': false,
    flex: true,
    'w-[1em]': true,
    'grow-0': true,
    'shrink-0': true,
  ...
  rating__ratingItem: {
    ...
    'focus-within:outline-teal-600': false,
    'w-[1.5em]': true,
    'h-[1.5em]': true,
  },
  ...
  toggle__track: {
    ...
    'transition-all': true,
    'bg-zinc-400': true,
    'peer-checked:bg-teal-600': false,
  ...
  togglebuttons__input: {
    ...
    'dark:text-teal-500': true,
    'aria-[pressed=true]:bg-teal-600': false,
    'aria-[pressed=true]:text-white': true,
    'dark:aria-[pressed=true]:bg-teal-600': false,
    ...
    'group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-teal-600': false,
    'group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-teal-600': false,
    'dark:group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-teal-600': false,
    'dark:group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-teal-600': false,
    'dark:group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-teal-600': false,
    ...
    'group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-teal-600': false,
    'group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-teal-600': false,
    'dark:group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-teal-600': false,
    'dark:group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-teal-600': false,
    'dark:group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-teal-600': false,
  },
  transferlist__outer: {
    group: true,
    'min-w-0': true,
    ...
    'text-sm': true,
    'max-w-none': true,
    '[&_.dnd-placeholder]:bg-teal-600': false,
  ...
  transferlist__transferlistListItem: {
    ...
    'dark:data-[is-active=true]:ring-teal-600': false,
    'dark:aria-selected:ring-teal-600': false,
  ...
  'multi-step__tab': {
    ...
    'group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-teal-600': false,
    ...
    'dark:group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-teal-600': false,
  },
  ...
  'multi-step__badge': {
    ...
    'text-white': true,
    'rounded-full': true,
    'group-data-[valid=true]/tab:bg-teal-600': false,
